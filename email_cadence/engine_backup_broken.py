...
def cta_html(x, step):
    ...
    return (
        f"<br><br>Se fizer sentido, me ajuda respondendo isso aqui? Leva 1 min:<br><br>"
        f"<a href='http://191.252.184.140:8001/t/{deal_id}/{step}?r=https://docs.google.com/forms/d/1KWo-Z7uKflvpR0Ff9yxFJhyV-iFtm0v4xH3QKC9FRmo/viewform?usp=header' "
        f"style='color:#2563eb;text-decoration:underline;font-weight:600;'>Responder em 1 minuto</a>"
    )
